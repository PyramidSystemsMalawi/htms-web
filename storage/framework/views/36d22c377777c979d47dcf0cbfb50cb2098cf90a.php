    ...
    <div class="sidebar">
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            <a href="/districts" class="nav-link <?php if($title == 'Districts'): ?> active <?php endif; ?>">
...
<?php /**PATH /Users/linnos/Projects/Private/Security/Source/htms-web/resources/views/layouts/main.blade.php ENDPATH**/ ?>